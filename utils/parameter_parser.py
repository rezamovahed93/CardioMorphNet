...
def parse_args_data_splitting():
    ...
    parser.add_argument("--csv_paths", metavar='m2m_w', type=str, default="/data/MyPhD/My PHD Datasets/UKB Heart Images NIFTI/patient_data.csv" , help="The path of obatined CSV file for UKB dataset")
...
def parse_args_preprocess():
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    parser.add_argument("--data_path", metavar='dp', type=str, default=r"/data/MyPhD/My PHD Datasets/UKB Heart Images NIFTI/", help="The path of the UKB dataset in NIFTI format")    
    parser.add_argument("--preprocessed_data_path", metavar='dp', type=str, default=r"/data/MyPhD/My PHD Datasets/UKB Heart Images NIFTI preprocessed/", help="The path for the preprocessed data" )
...
def parse_args_train_reg_search():
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    parser.add_argument("--data_path", metavar='dp', type=str, default=r"/data/MyPhD/My PHD Datasets/UKB Heart Images Preprocessed Zero Padded", help="The path of the preprocessed UKB dataset")    
